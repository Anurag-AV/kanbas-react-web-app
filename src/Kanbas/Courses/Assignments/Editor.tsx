...
import { addAssignment, editAssignment, setAssignments } from "./reducer";
...
export default function AssignmentEditor() {
  ...
  const [title, setTitle] = useState(assignment.title);
    ...
    const updateAssignment = async () => {
      const newAssignment = {_id:aid,course: cid, title,
        type,
        availableDate,
        availableTime,
        dueDate,
        ...
        points,
        description,};
        console.log("saving", newAssignment)
  ...
  const fetchAssignment = async () => {
    ...
    if (assignment.title){
      ...
      setAvailableDate(assignment.availableDate ?? null);  
      setAvailableTime(assignment.availableTime ?? null); 
