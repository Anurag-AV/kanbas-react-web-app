  ...
  return (
    <div id="wd-course-status" style={{ width: "300px" }}>
      ...
      <button
        ...
        className="btn btn-lg btn-secondary w-100 mt-1 text-start"
      >
        <IoBarChartSharp className="me-2 fs-5" /> View Course Stream{" "}
      </button>
      <button
        id="wd-view-progress"
        className="btn btn-lg btn-secondary w-100 mt-1 text-start"
      >
        <TfiAnnouncement className="me-2 fs-5" /> New Anouncement{" "}
      </button>
      <button
        id="wd-view-progress"
        className="btn btn-lg btn-secondary w-100 mt-1 text-start"
      >
        <AiOutlineLineChart className="me-2 fs-5" /> New Analysis{" "}
      </button>
      <button
        id="wd-view-progress"
        className="btn btn-lg btn-secondary w-100 mt-1 text-start"
